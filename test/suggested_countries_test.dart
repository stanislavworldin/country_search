...
void main() {
  group('Suggested Countries Tests', () {
    test(
        ...
        () {
      final frenchCountries =
          CountryLanguageMapping.getSuggestedCountries('fr');
    ...
    test(
        ...
        () {
      final spanishCountries =
          CountryLanguageMapping.getSuggestedCountries('es');
    ...
    test(
        ...
        () {
      final germanCountries =
          CountryLanguageMapping.getSuggestedCountries('de');
    ...
    test('CountryLanguageMapping returns English countries as fallback', () {
      final englishCountries =
          CountryLanguageMapping.getSuggestedCountries('en');
    ...
    test('CountryLanguageMapping returns fallback for unsupported language',
      ...
      final fallbackCountries =
          CountryLanguageMapping.getSuggestedCountries('xx');
    ...
    testWidgets('CountryPicker works without suggested countries when disabled',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    test('Suggested countries are properly organized', () {
      ...
      for (final suggestedCode in frenchCountries) {
        final found =
            allCountries.any((country) => country.code == suggestedCode);
        expect(found, isTrue,
            reason:
    ...
    test('All supported languages have suggested countries', () {
      ...
      for (final language in supportedLanguages) {
        final suggestedCountries =
            CountryLanguageMapping.getSuggestedCountries(language);
        expect(suggestedCountries, isNotEmpty,
